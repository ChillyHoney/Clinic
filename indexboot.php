...
if (
    ...
    $sql = "insert into pacjenci (imie, nazwisko, data_urodzenia, pesel) values ('$imie', '$nazwisko', '$data_urodzenia', '$pesel')";
...
<html lang="en">
  <head>
    ...
    <title>Pacjenci - przychodnia+</title>
    <style>
...
<div class = "">
<div class="float-sm-left"><p> <a href="wizyta.php" >
...
<!-- -->
  ...
  <thead>
    <tr>
      ...
      <th scope="col">data_urodzenia</th>
